...
if (defined('YITH_WCQV')) {
    function sparklestore_quickview() {
        ...
        echo '<a href="#" class="link-quickview yith-wcqv-button" data-product_id="' . intval( $product->get_id() ) . '"><span class="sparkle-tooltip-label">'.esc_html( $label ).'</span>' . esc_html( $label ) . '</a>';
    }
}
    ...
    <div class="product_wrapper">
        <div class="store_products_item">
            <div class="store_products_item_body">
                ...
                <?php if( function_exists( 'sparklestore_quickview' ) || function_exists( 'sparklestore_add_compare_link' ) || function_exists( 'sparklestore_wishlist_products' ) ){ ?>
